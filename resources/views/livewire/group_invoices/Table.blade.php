                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                            data-target="#delete_invoice" wire:click="prepareForDelete({{ $group_invoice->id }})"
                            {{-- <-- تغيير هنا: استدعاء دالة تحضيرية --}} title="حذف الفاتورة"> {{-- إضافة title --}}
                            <i class="fa fa-trash"></i>
                        </button> <a href="#" wire:click="print({{ $group_invoice->id }})"
