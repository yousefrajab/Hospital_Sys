<div class="main-sidemenu">
        ...
        <div class="dropdown user-pro-body">
            <div class="">
                <img alt="user-img" class="avatar avatar-xl brround"
                    src="{{ URL::asset('Dashboard/img/faces/doctor_default.png') }}"><span
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('admin.Service.index') }}">{{ trans('main-sidebar_trans.Single_service') }}</a></li>
                <li><a class="slide-item"
                        href="{{ route('admin.Add_GroupServices') }}">{{ trans('main-sidebar_trans.group_services') }}</a>
                </li>
                <li><a class="slide-item"
                        href="{{ route('admin.insurance.index') }}">{{ trans('main-sidebar_trans.Insurance') }}</a></li>
                <li><a class="slide-item"
                        href="{{ route('admin.Ambulance.index') }}">{{ trans('main-sidebar_trans.ambulance') }}</a></li>
                <li><a class="slide-item"
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">المرضي</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('admin.Patients.create') }}">اضافة مريض</a></li>
                <li><a class="slide-item" href="{{ route('admin.Patients.index') }}">قائمة المرضي</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('admin.laboratorie_employee.index') }}">قائمة الموظفين</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('admin.appointments.index') }}">قائمة المواعيد الغير مؤكدة</a></li>
                 <li><a class="slide-item" href="{{ route('admin.appointments.index2') }}">قائمة المواعيد المؤكدة</a></li>
