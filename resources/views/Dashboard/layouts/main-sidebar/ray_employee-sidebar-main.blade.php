...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-lg rounded-circle user-avatar"
                        src="{{ Auth::guard('ray_employee')->user()->image ? asset('Dashboard/img/rayEmployees/' . Auth::guard('ray_employee')->user()->image->filename) : asset('Dashboard/img/ray_employee_default.png') }}">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ route('ray_employee.profile.show') }}">
                ...
                <ul class="slide-menu">
                    <li>
                        <a class="slide-item" href="{{ route('ray_employee.profile.show') }}">
                            <i class="fa fa-eye mr-2"></i> عرض الملف الشخصي
                        </a>
                    </li>
                    <li>
                        <a class="slide-item" href="{{ route('ray_employee.profile.edit') }}">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">كشوفات الاشعة </span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('ray_employee.invoices_ray_employee.index') }}">قائمة الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('ray_employee.completed_invoices') }}">قائمة الكشوفات المكتملة</a></li>
                </ul>
            </li>
        </ul>
    </div>
