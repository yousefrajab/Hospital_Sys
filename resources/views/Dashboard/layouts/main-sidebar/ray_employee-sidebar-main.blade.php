    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('ray_employee.invoices_ray_employee.index') }}">قائمة
                            الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('ray_employee.completed_invoices') }}">قائمة الكشوفات
                            المكتملة</a></li>
                </ul>
            </li>
        </ul>
