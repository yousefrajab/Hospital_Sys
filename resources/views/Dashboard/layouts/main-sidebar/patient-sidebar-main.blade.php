...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ route('patient.profile.show') }}">
                ...
                <ul class="slide-menu">
                    <li>
                        <a class="slide-item" href="{{ route('patient.profile.show') }}">
                            <i class="fa fa-eye mr-2"></i> عرض الملف الشخصي
                        </a>
                    </li>
                    <li>
                        <a class="slide-item" href="{{ route('patient.profile.edit') }}">
