    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices_laboratorie_employee.index') }}">قائمة
                            الكشوفات</a></li>
                    <li><a class="slide-item" href="{{ route('completed_invoicess') }}">قائمة الكشوفات المكتملة</a>
                    </li>
                </ul>
            </li>
        </ul>
