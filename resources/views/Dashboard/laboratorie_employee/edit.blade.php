<!-- Enhanced Edit Laboratory Employee Modal -->
<div class="modal fade" id="edit{{ $laboratorie_employee->id }}" tabindex="-1" role="dialog" aria-labelledby="editEmployeeLabel{{ $laboratorie_employee->id }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content shadow-lg border-0">
            <!-- Modal Header with Gradient Background -->
            <div class="modal-header bg-gradient-primary text-white">
                <h5 class="modal-title" id="editEmployeeLabel{{ $laboratorie_employee->id }}">
                    <i class="fas fa-user-edit mr-2"></i>تعديل بيانات موظف المختبر
                </h5>
            ...
            <form action="{{ route('admin.laboratorie_employee.update', $laboratorie_employee->id) }}" method="post" autocomplete="off">
                @method('patch')
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $laboratorie_employee->name }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="national_id" value="{{ $laboratorie_employee->national_id }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" value="{{ $laboratorie_employee->email }}"
