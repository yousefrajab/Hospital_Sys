...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">المختبر</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة الموظفين</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
        ...
        <div class="card employee-table-card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover text-md-nowrap" id="example2">
                        <thead>
                        <tr>
                            <th>#</th>
                            <th>الاسم</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <a class="btn btn-sm btn-info mr-2" data-effect="effect-scale" data-toggle="modal" href="#edit{{$laboratorie_employee->id}}" title="تعديل">
                                            <i class="las la-pen"></i>
                                        </a>
                                        <a class="btn btn-sm btn-danger" data-effect="effect-scale" data-toggle="modal" href="#delete{{$laboratorie_employee->id}}" title="حذف">
