...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">سند قبض</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ طباعة السند</span>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="invoice-header">
                            <div class="text-center">
                                ...
                                <p class="invoice-number">رقم السند: #{{ $receipt->id }}</p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <div class="billed-to">
                                        ...
                                        <p>{{ $receipt->patients->name }}<br>
                                            رقم الملف: {{ $receipt->patients->id }}<br>
                                            الهاتف: {{ $receipt->patients->Phone ?? 'غير متوفر' }}<br>
                                            الاميل: {{ $receipt->patients->email ?? 'غير متوفر' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mg-t-20">
                            <div class="col-md-6">
                                ...
                                <p class="invoice-info-row"><span>تاريخ الإصدار:</span> <span>{{ $receipt->date }}</span></p>
                        ...
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>{{ $receipt->description ?? 'لا توجد ملاحظات' }}</td>
