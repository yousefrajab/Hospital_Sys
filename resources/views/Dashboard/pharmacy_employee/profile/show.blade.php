    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex align-items-center">
                <h4 class="content-title mb-0 my-auto">الصيدلي</h4>
        ...
        <div class="ray-profile-card ray-animate">
            ...
            <div class="ray-profile-header">
                <img class="ray-profile-avatar"
                     src="{{ $employee->image ? asset('Dashboard/img/pharmacyEmployees/' . $employee->image->filename) : asset('Dashboard/img/default_avatar.png') }}"
                     alt="{{ $employee->name }}">
                <h2 class="ray-profile-name">{{ $employee->name }}</h2>
                <span class="ray-profile-title">
                    <i class="fas fa-x-ray me-2"></i> الصيدلي
                </span>
            ...
            <div class="ray-profile-actions">
                <a href="{{ route('pharmacy_employee.profile.edit') }}" class="ray-edit-btn">
