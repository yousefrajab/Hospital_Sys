{{-- resources/views/Dashboard/pharmacy_employee/profile/edit.blade.php --}}
...
@section('page-header')
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <a href="{{ route('pharmacy_employee.profile.show') }}" class="btn btn-outline-secondary btn-sm">
...
@section('content')
    ...
    <div class="ray-edit-container">
        <div class="ray-edit-card ray-animate">
            ...
            <form action="{{ route('pharmacy_employee.profile.update') }}" method="POST" enctype="multipart/form-data" class="ray-edit-body needs-validation" novalidate>
                @method('PUT')
                @csrf
                ...
                <div class="ray-form-actions">
                    <a href="{{ route('pharmacy_employee.profile.show') }}" class="ray-btn ray-btn-outline">
...
@section('js')
    ...
    <script>
        ...
        function rayDisplayFileNameAndPreview(input) {
            ...
            const originalImage = "{{ $employee->image ? asset('Dashboard/img/pharmacyEmployees/' . $employee->image->filename) : asset('Dashboard/img/default_avatar.png') }}";
