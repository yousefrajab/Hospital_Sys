...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addPharmacyEmployeeLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-header" style="background: linear-gradient(135deg, var(--primary-color, #4A90E2), var(--secondary-color, #50E3C2)); color: white;">
                <h5 class="modal-title" id="addPharmacyEmployeeLabel">
                    <i class="fas fa-user-plus mr-2"></i>إضافة موظف صيدلي جديد
                </h5>
            ...
            <!-- Form -->
            <form action="{{ route('admin.pharmacy_employee.store') }}" method="post" enctype="multipart/form-data"
                autocomplete="off" id="addPharmacyEmployeeLabel">
                @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="national_id" value="{{ old('national_id') }}" class="form-control rounded-lg shadow-sm"
                                    placeholder="أدخل رقم الهوية" pattern="[0-9]{9,10}" maxlength="9"
