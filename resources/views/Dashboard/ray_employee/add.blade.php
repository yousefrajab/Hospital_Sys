<!-- Enhanced Add Ray Employee Modal -->
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addRayEmployeeLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content shadow-lg border-0">
            <!-- Modal Header -->
            <div class="modal-header bg-gradient-primary text-white">
                <h5 class="modal-title" id="addRayEmployeeLabel">
            ...
            <!-- Form -->
            <form action="{{ route('admin.ray_employee.store') }}" method="post" autocomplete="off">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control rounded-lg shadow-sm"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="national_id" class="form-control rounded-lg shadow-sm"
                                    placeholder="أدخل رقم الهوية" pattern="[0-9]{9}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control rounded-lg shadow-sm"
...
<!-- Script -->
<!-- Ensure jQuery and Font Awesome are loaded -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="https://kit.fontawesome.com/a076d05399.js"></script>

<script>
    $(document).ready(function() {
        // التعامل مع تغيير نوع حقل الإدخال عند النقر على أيقونة العين
