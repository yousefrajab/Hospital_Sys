{{-- resources/views/Dashboard/pharmacy_manager/profile/edit.blade.php --}}
...
@section('page-header')
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            <a href="{{ route('pharmacy_manager.profile.show') }}" class="btn btn-outline-secondary btn-sm">
...
@section('content')
    ...
    <div class="ray-edit-container">
        <div class="ray-edit-card ray-animate">
            ...
            <form action="{{ route('pharmacy_manager.profile.update') }}" method="POST" enctype="multipart/form-data" class="ray-edit-body needs-validation" novalidate>
                @method('PUT')
                @csrf
                ...
                <div class="ray-form-actions">
                    <a href="{{ route('pharmacy_manager.profile.show') }}" class="ray-btn ray-btn-outline">
