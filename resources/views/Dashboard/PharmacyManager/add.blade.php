...
<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="addPharmacyManagerLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content shadow-lg border-0">
            ...
            <div class="modal-header" style="background: linear-gradient(135deg, var(--primary-color, #4A90E2), var(--secondary-color, #50E3C2)); color: white;">
                <h5 class="modal-title" id="addPharmacyManagerLabel">
                    <i class="fas fa-user-plus mr-2"></i>إضافة مدبر صيدلية جديد
                </h5>
            ...
            <!-- Form -->
            <form action="{{ route('admin.pharmacy_manager.store') }}" method="post" enctype="multipart/form-data"
                autocomplete="off" id="addPharmacyManagerForm">
                @csrf
