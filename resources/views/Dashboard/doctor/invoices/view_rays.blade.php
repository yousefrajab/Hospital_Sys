...
.gallery-img {
    width: 100%; /* اجعل الصورة تأخذ عرض العنصر بالكامل */
    height: 250px; /* ارتفاع مناسب للصور */
    object-fit: cover; /* تأكد من أن الصورة تغطي الإطار بشكل جيد */
    border-radius: 8px; /* حواف دائرية للمظهر الاحترافي */
    transition: transform 0.3s ease-in-out; /* تأثير عند تمرير الماوس */
}
