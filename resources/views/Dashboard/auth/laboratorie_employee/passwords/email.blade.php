...
@section('title', 'طلب إعادة تعيين كلمة مرور موظف المختبر')
        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card auth-card my-5">
                <div class="card-header auth-card-header text-center">
                    <h4 class="mb-0">إعادة تعيين كلمة المرور (موظف المختبر)</h4>
                </div>
                ...
                <div class="card-body auth-card-body">
                    ...
                    <form method="POST" action="{{ route('laboratorie_employee.password.email') }}" class="needs-validation" novalidate>
                        @csrf
                    ...
                    @if (Route::has('laboratorie_employee.login')) {{-- افترض أن لديك route تسجيل دخول للأدمن --}}
                        <div class="text-center mt-4">
                            <a href="{{ route('laboratorie_employee.login') }}">العودة لتسجيل الدخول</a>
                        </div>
                    @endif
                </div>
            </div>
