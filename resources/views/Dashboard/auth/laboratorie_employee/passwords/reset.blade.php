...
@section('title', 'إعادة تعيين كلمة المرور -  موظف المختبر')
        ...
        <div class="col-md-8 col-lg-6 col-xl-5">
            <div class="card auth-card my-5">
                ...
                <div class="card-body auth-card-body">
                    <form method="POST" action="{{ route('laboratorie_employee.password.update') }}" class="needs-validation" novalidate>
                        @csrf
