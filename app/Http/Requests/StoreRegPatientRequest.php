...
class StoreRegPatientRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'Allergies' => 'nullable|string|max:1000', // من الـ textarea
            'chronic_diseases' => 'nullable|array', // نتوقع مصفوفة هنا
            ...
            // 'chronic_diseases.*.diagnosed_by' => 'nullable|string|max:255', // اختياري
            'chronic_diseases.*.current_status' => ['nullable', 'string', Rule::in(array_keys(PatientChronicDisease::getStatuses()))],
            // 'chronic_diseases.*.treatment_plan' => 'nullable|string|max:1000', // اختياري
