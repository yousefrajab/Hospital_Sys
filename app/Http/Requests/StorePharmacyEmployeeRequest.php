...
class StorePharmacyEmployeeRequest extends FormRequest
{
    /**
    ...
    {
        $employeeId = $this->route('pharmacy_employee'); // تأكد من اسم البارامتر في الراوت
        ...
        return [
            ...
            'national_id' => [
                'required',
                'string',
                Rule::unique('pharmacy_employees', 'national_id'), // 1. فريد في جدول pharmacy_employees
            ...
            'email' => [
                'required',
                'email',
                Rule::unique('pharmacy_employees', 'email'), // 1. فريد في جدول pharmacy_employees
