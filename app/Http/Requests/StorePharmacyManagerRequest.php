...
class StorePharmacyManagerRequest extends FormRequest
{
    /**
    ...
    {
        $employeeId = $this->route('pharmacy_manager'); // تأكد من اسم البارامتر في الراوت
        ...
        return [
            ...
            'national_id' => [
                'required',
                'string',
                Rule::unique('pharmacy_managers', 'national_id'), // 1. فريد في جدول pharmacy_managers
            ...
            'email' => [
                'required',
                'email',
                Rule::unique('pharmacy_managers', 'email'), // 1. فريد في جدول pharmacy_managers
