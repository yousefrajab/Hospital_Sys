...
class ResetPasswordController extends Controller // ** تأكد أن اسم الكلاس هو ResetPasswordController **
{
    ...
    public function __construct()
    {
        ...
        $this->redirectTo = route('dashboard.patient'); // أو RouteServiceProvider::ADMIN إذا كان معرفًا
    }

    public function showResetForm(Request $request, $token = null)
    {
        // resources/views/Dashboard/auth/patient/passwords/reset.blade.php
        return view('Dashboard.auth.patient.passwords.reset')->with(
    ...
    public function reset(Request $request)
    {
        ...
        if ($response == Password::PASSWORD_RESET) {
            ...
            // Auth::guard('patient')->login($user); // $user هو المستخدم الذي تم تحديثه
