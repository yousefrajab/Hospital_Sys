...
class ForgotPasswordController extends Controller // ** تأكد أن اسم الكلاس هو ForgotPasswordController **
{
    public function __construct()
    {
        ...
        $this->middleware('guest:patient'); // فقط الضيوف من guard الأدمن
    }
    ...
    public function showLinkRequestForm()
    {
        ...
        return view('Dashboard.auth.patient.passwords.email');
    }
    ...
    public function sendResetLinkEmail(Request $request)
    {
        ...
        // استخدام الـ broker 'patients' الذي عرفناه في config/auth.php
        // Password::broker('patients') يحدد أننا نعمل مع إعدادات 'patients' في config/auth.php -> passwords
